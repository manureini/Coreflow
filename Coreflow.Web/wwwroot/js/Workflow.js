...
$(function () {
    ...
    $("#RunWorkflowbtn").click(SubmitRunWorkflow);
    ...
    $(document).on("click", ".add-referenced-namespace", function () {
        ...
        $(this).next("input").val("");
        SubmitWorkflowReferencedNamespaceChanged(true, value);
    });
    $(document).on("click", ".remove-referenced-namespace", function () {
        $(this).parent().remove();
        SubmitWorkflowReferencedNamespaceChanged(false, $(this).data("id"));
    });
    ...
    $(document).on("click", ".add-referenced-assembly", function () {
        var value = $(this).next("input").val();
        $(this).next("input").val("");
        SubmitWorkflowReferencedAssemblyChanged(true, value);
    });
    $(document).on("click", ".remove-referenced-assembly", function () {
        $(this).parent().remove();
        SubmitWorkflowReferencedAssemblyChanged(false, $(this).data("id"));
    });
