...
namespace Coreflow.Helper
{
    public class WorkflowDefinitionFactory
    {
        ...
        internal WorkflowDefinitionFactory(Coreflow pCoreflow)
        {
            mCoreflow = pCoreflow;
     ...
     //            "System.Linq.Expressions.dll",
        ...
        public WorkflowDefinition Create(string pName)
        {
            WorkflowDefinition w = new WorkflowDefinition(mCoreflow)
            {
                Name = pName,
                ReferencedNamespaces = DefaultReferencedNamespaces,
                ReferencedAssemblies = DefaultReferencedAssemblies,
                Arguments = new List<WorkflowArguments>(),
            };

            mCoreflow.WorkflowDefinitionStorage.Add(w);
            return w;
        }
    }
}
